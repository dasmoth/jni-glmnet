...
gcc -mmacosx-version-min=10.4 -dynamiclib -o libglmnet.jnilib glmnet.o newGLMnet_f.o -lm -static-libgcc /usr/local/lib/libgfortran.a /usr/local/lib/libquadmath.a
